...
class TestScraper(unittest.TestCase):
    def test_construct_url(self):
        ...
        self.assertEqual(url1,
                         'https://www.data.jma.go.jp/obd/stats/etrn/view/10min_s1.php?prec_no=44&block_no=47662&year=2018&month=12&day=15&view=p1'
                         )
    ...
    def test_fetch_weather_by_10(self):
        ...
        self.assertEqual(df.timestamp[24*6-1], pandas.to_datetime('2018-12-16 00:00:00').tz_localize('Asia/Tokyo'))
    ...
    def test_fetch_hourly_weather(self):
        ...
        self.assertEqual(df.timestamp[24-1], pandas.to_datetime('2018-12-16 00:00:00').tz_localize('Asia/Tokyo'))
